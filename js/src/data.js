...
(function() {
  var Config, Database, Dialog, Global, Looks, Stars, check, config, current_count, data, debugmode, inicheck, log, looks, next, reset_looks, set_global, set_stars, stars, table_count, time,
