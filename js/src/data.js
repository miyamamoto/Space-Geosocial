...
(function() {
  var Config, Database, Global, Looks, Stars, check, config, current_count, data, debugmode, log, looks, next, reset_looks, set_global, stars, stars_version, table_count,
  ...
  Looks = (function(_super) {
    ...
    Looks.prototype.reset_params = function(cb) {
      var _this = this;
      this.time = new Orb.Time(new Date());
        ...
        if (error === null && ((results != null ? (_ref = results.rows) != null ? _ref.length : void 0 : void 0) != null) && results.rows.length > 0) {
          ...
          return _this.delete_all(function() {
            ...
            for (_i = 0, _len = stars.length; _i < _len; _i++) {
              ...
              look = observe.horizontal(_this.time);
              queries.push({
