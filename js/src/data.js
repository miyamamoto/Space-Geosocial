...
(function() {
  var Config, Database, Global, Looks, Stars, check, config, current_count, data, date, debugmode, log, looks, next, observer, reset_looks, set_global, stars, stars_version, table_count, time,
